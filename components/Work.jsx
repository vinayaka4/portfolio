        ...
        <div>
            <motion.div
                ...
                <motion.p
                    ...
                    className='text text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
                    Explore a collection of projects showcasing my expertise in HCI and Software Development.
                </motion.p>
                <motion.div
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
